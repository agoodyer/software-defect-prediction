...
The second dataset used is the baseline from the Github Pull Request (GHRP) dataset. It was created using the CK code metrics tool on the 6052 instances of bug related pull requests. It contains the SHA to the sample code instance, 21 static code metrics, and a label (1/0) informing whether there is a defect or not for every instance.
