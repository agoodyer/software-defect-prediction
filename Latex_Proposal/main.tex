...
The NASA Promise dataset is comprised of 21 static code metrics along with a binary Y/N label indicating the presence of defects. We plan to use all of the included metrics in our model.
...
\begin{table}[htbp]
    \centering
    % Adjust font size here: \small, \footnotesize, or \scriptsize
    \footnotesize 

    
    % \columnwidth makes the table fit the current column width (perfect for 2-column papers)
    % 'l' is a standard left-aligned column for the short metric names
    % 'X' is a flexible column that wraps text automatically
    \begin{tabularx}{\columnwidth}{@{} l X @{}}
        ...
        \bottomrule
    \end{tabularx}
        \caption{The summary of code metrics\label{tab:metrics}}
\end{table}
